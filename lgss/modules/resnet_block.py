...
from lgss.modules.common import ConvType, NormType, get_norm, conv
...
class NoReluBlock(BasicBlockBase):
    ...
    def __init__(self, source_block):
        ...
        super(NoReluBlock, self).__init__(inplanes=source_block.inplanes, planes=source_block.planes)
